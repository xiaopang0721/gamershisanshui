...
module ui.nqp.game_ui.shisanshui {
    export class ShiSanShuiUI extends View {
		...
		public vw_card:ui.ajqp.game_ui.tongyong.FangKa_GoUI;
        ...
        createChildren():void {
			...
			View.regComponent("ui.ajqp.game_ui.tongyong.FangKa_GoUI",ui.ajqp.game_ui.tongyong.FangKa_GoUI);
